// ========== Azure Key Vault (Network Isolated) ========== //
// Same as original, with NETWORK ISOLATION CHANGE:
...
resource keyVault 'Microsoft.KeyVault/vaults@2023-07-01' = {
  ...
  properties: {
    ...
    // NETWORK ISOLATION CHANGE: Block all public access.
    // Secrets are only readable from inside the VNet via private endpoint.
    publicNetworkAccess: 'Disabled'
    networkAcls: {
      defaultAction: 'Deny'
      bypass: 'AzureServices'   // Allow trusted Azure services (like Container Apps with MI).
    }
  }
}
